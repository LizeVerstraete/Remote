...
cd /esat/biomeddata/kkontras/r0786880/models/remote
export PYTHONPATH='/esat/biomeddata/kkontras/r0786880/models/remote/:$PYTHONPATH'
echo $PWD
...
echo "Current PATH: $PATH"
python /esat/biomeddata/kkontras/r0786880/models/remote/preprocessing_parallel.py
echo "Job finished"